...
export type RunStatus = 'active' | 'completed' | 'failed' | 'waiting_decision';
export type DecisionStatus = 'pending' | 'resolved' | 'auto_executed' | 'expired';
export type ExecutionMode = 'auto' | 'requires_approval';
